...
"
    >
      <div className="bg-white rounded-md p-8 w-max shadow-md flex flex-col">
        ...
        <button className="text-white bg-black border-2 border-black rounded-md py-2 px-4 lg:hover:text-black lg:hover:bg-white transition duration-250 cursor-pointer mb-2">
          Sign In with Google
        </button>
