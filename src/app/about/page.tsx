        ...
        <div className="mx-auto my-4 w-5/6">
            ...
            <section className="mb-4">
                ...
                <p>
                    ...
                    global brand with a dedicated team working tirelessly to
            ...
            <section className="mb-4">
                ...
                <p>
                    To empower people with the technology they need to enhance
                    their lives and stay connected in an ever-evolving digital
                    world.
                </p>
            </section>
            ...
            <section>
                ...
                <ul>
                    <li>
                        <strong>Curated Selection:</strong> We handpick every
                        product in our catalog to ensure quality and value.
                    </li>
                    <li>
                        <strong>Fast Shipping:</strong> Your order is processed
                        and shipped as quickly as possible, so you can start
                        enjoying your new gadgets right away.
                    </li>
                    <li>
                        <strong>Customer-Centric:</strong> We’re here for you –
                        with 24/7 support and a no-questions-asked return
                        policy.
                    </li>
                </ul>
            </section>
